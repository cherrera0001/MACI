...
| `[GUILLITO]` | **Explicación pedagógica tuya**: analogía, ejemplo inventado |

`[GUILLITO]` no es de segunda categoría — una buena analogía es trabajo docente
...
etiqueta el resto como `[GUILLITO]` o `[INFERENCIA]`. No te detengas y no lo
ocultes.
