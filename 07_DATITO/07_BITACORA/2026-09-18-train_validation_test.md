...
- Explicación intuitiva con la analogía del ensayo de práctica `[DATITO]`.
...
## Corrección de Datito sobre sí mismo
...
`07_DATITO/osint_gran_concepcion.md`. Pregunta pendiente de respuesta sobre
