...
ensenar: para eso esta la skill `guillito`.
...
Lee tambien `07_GUILLITO/curriculum.yaml` para los nombres legibles y el orden.
...
- **patrones_vigilados**: trampas que Guillito anticipa, que **no** son fallos suyos
...
Distingue estudiado de comprendido: `EN_ESTUDIO` significa que Guillito lo
explico, no que Cristobal lo entendio.

Si el registro esta vacio porque aun no hay diagnostico inicial
(`diagnostico_inicial_hecho: false`), dilo en una linea y sugiere `/guillito`.
