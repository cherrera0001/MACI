...
`07_GUILLITO/entregas/`. Si no encuentras nada, dilo y termina — no inventes
respuestas suyas.

Necesitas tambien el enunciado. Suele estar en `07_GUILLITO/certamenes/` o
`07_GUILLITO/cuadernillos/`. Si el enunciado no aparece, pidelo y termina.
...
Lee `07_GUILLITO/referencia/memoria.md` antes de escribir en los registros, y
`07_GUILLITO/patron_evaluacion.md` para corregir con el criterio del profesor.
...
Actualiza `07_GUILLITO/progreso.yaml` y `errores_conceptuales.yaml` segun
